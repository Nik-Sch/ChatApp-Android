...
public final class EmojiconHandler{
  ...
  private static final Map<String, Integer> sEmojisModifiedMap = new HashMap<>();
...
//        Emoji.fromChars("\u0023\u20e3"),
  ...
  private static int getEmojiResouce(int codePoint){
  ...
  public static void addEmojis(Context context,
    ...
    for (EmojiconSpan span : oldSpans)
    ...
    for (int i = index; i < textLengthToProcess;i += skip){
      ...
      if (icon == 0){
        ...
        if (i + skip < textLengthToProcess){
          ...
          if (followUnicode == 0xfe0f){
            ...
            // this is only compatibility for some older ios versions just in case
            int followSkip = Character.charCount(followUnicode);
            int tempIcon = getKeyCapEmoji(unicode);
            if (tempIcon == 0)
              followSkip = 0;
            ...
            int followSkip = Character.charCount(followUnicode);
            String hexUnicde = Integer.toHexString(unicode);
      ...
      if (icon > 0)
        text.setSpan(new EmojiconSpan(context, icon, emojiSize, emojiAlignment, textSize), i, i +
